...
const OrderDetails: React.FC = () => {
    ...
    const handleChat = async () => {
        ...
        try {
            ...
            if (chat?.id) {
                router.push(`/cabinet/chat/${chat.id}`);
            } else {
                router.push(`/cabinet/chat`);
            }
        } catch (e) {
    ...
    const handleContinue = () => {
        router.push(`/cabinet/orders/create?uuid=${order.id}`);
    };
    ...
    return (
        <div className={style.container}>
            <div className={style.header}>
                <button className={style.backBtn} onClick={() => router.push('/cabinet/orders')}>
                                ...
                                <div className={style.workerContent}>
                                    <div className={style.workerRow}>
                                        ...
                                        <div className={style.workerInfo}>
                                            ...
                                            <Link href={`/sitter/${worker.id}`} className={style.profileLinkText} target="_blank" rel="noopener noreferrer">
                                                Открыть профиль
                                            </Link>
                                        </div>
