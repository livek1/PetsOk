    ...
    return (
        <div className={style.formContainer}>
            ...
            <div className={style.topNav}>
                <Link href="/cabinet/pets" className={style.backButton}>
                    <BackIcon /> {t('common.back', 'Назад')}
                </Link>
                <div className={style.topActions}>
                    <Link href={`/cabinet/pets/${id}/edit`} className={style.btnIconPrimary} title={t('common.edit')}>
                        <EditIcon />
                    </Link>
