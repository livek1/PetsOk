...
import StepTests from '../become-sitter/steps/StepTests';
import ServiceConfigurationCard from '../become-sitter/steps/ServiceConfigurationCard';
            ...
            <div className={style.sectionCard}>
                ...
                <div className={style.formGroup} style={{ backgroundColor: '#F8F9FB', padding: '16px', borderRadius: '10px', border: '1px solid #E2E8F0' }}>
                    ...
                    <div style={{ paddingLeft: '28px' }}>
                        ...
                        <Link href="/cabinet/profile" style={{ fontSize: '0.9rem', color: '#3598FE', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
