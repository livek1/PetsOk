// --- File: src/components/HowItWorksSimple.tsx ---
...
const HowItWorksSimple: React.FC = () => {
    ...
    const steps = [
        {
            id: "step1",
            imageUrl: Imagestep1, // Assumed 130x130px
            titleKey: "howItWorksSimple.step1.title",
            descriptionKey: "howItWorksSimple.step1.desc",
        },
        {
            id: "step2",
            imageUrl: Imagestep2, // Assumed 130x130px
            titleKey: "howItWorksSimple.step2.title",
            descriptionKey: "howItWorksSimple.step2.desc",
        },
        {
            id: "step3",
            imageUrl: Imagestep3, // Assumed 130x130px
            titleKey: "howItWorksSimple.step3.title",
            descriptionKey: "howItWorksSimple.step3.desc",
        },
    ];
    ...
    const stepVariants = {
        ...
        visible: (i: number) => ({
            opacity: 1,
            y: 0,
            transition: { delay: i * 0.2, duration: 0.55, ease: "easeOut" },
        }),
    };
    ...
    return (
        <section className="how-it-works-simple wrapper">
            <motion.h2
