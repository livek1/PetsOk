...
import { legalContentRu } from "./config/legalContent";

// ИСПРАВЛЕНИЕ: Безопасное обращение к localStorage для SSR (Server-Side Rendering)
      ...
      translation: {
        ...
        footer: {
          ...
          legal: {
            ...
            cookies: "Политика Куки (Cookie)"
          }
        },

        // --- COOKIE BANNER ---
        cookieConsent: {
          text: "Мы используем файлы куки (cookie), чтобы улучшить ваш опыт на нашем сайте. Оставаясь на сайте, вы соглашаетесь с нашей ",
          policyLink: "Политикой конфиденциальности и использования куки (cookie)",
        ...
        error: {
          ...
          "invalidEmail": "Некорректный формат эл. почты",
          ...
          "missingContactInfo": "Не указан телефон или Эл. почта"
        },
        auth: {
        ...
        login: {
          "mainTitle": "Вход",
          "subtitle": "Введите Эл. почту или телефон, чтобы погрузиться в мир заботы о питомцах",
          "labelEmail": "Электронная почта",
          "labelPhone": "Ваш Телефон",
          "placeholderEmail": "Введите вашу эл. почту",
        ...
        passwordScreen: {
          ...
          "subtitleEmail": "Для входа с эл. почтой {{email}}",
          "label": "Пароль",
          "placeholder": "••••••••••",
          "loginButton": "Войти",
        ...
        verifyCode: {
          ...
          "titleEmail": "Подтверждение эл. почты",
        ...
        authModal: {
          ...
          contactPlaceholderAirbnb: 'Эл. почта или номер телефона',
          labelEmail: 'Эл. почта',
          ...
          otpTitleAirbnb_email: "Подтвердите вашу эл. почту",
        ...
        validation: {
          contactRequired: "Введите эл. почту или телефон.",
          contactInvalid: "Некорректный формат эл. почты или телефона.",
        ...
        becomeSitter: {
          ...
          "benefit1Desc": "Доступно уникальное условие на рынке: 0% комиссии с заказов. Ты можешь получать ровно столько, сколько установил в прайсе.",
        ...
        premium_sitter_badge_short: "ПРО",
        ...
        testimonials: {
          tag: "Истории доверия",
          title: "Средняя оценка — 5.0. Уютнее, чем в любой зоогостинице.",
          subtitle: "Владельцы выбирают нас за домашнюю атмосферу, индивидуальный подход и ежедневные фотоотчеты. Почитайте их истории.",

          ratingLabel: "на основе реальных отзывов",

          // --- 10 ОТЗЫВОВ ---
          review1: {
            text: "Анна присылала такие крутые видео с прогулок, что я даже начала ревновать! Молли счастлива, а я впервые в отпуске была абсолютно спокойна.",
            author: "Елена",
            pet: "мама корги Молли"
          },
          review2: {
            text: "Боялся, что Барс будет стрессовать. Но судя по фото, он устроил себе лучший курортный отдых. Спасибо Максиму за терпение!",
            author: "Дмитрий",
            pet: "хозяин кота Барса"
          },
          review3: {
            text: "Найти ситтера за 2 часа до вылета? Реально. Рекс нагулян, накормлен и зацелован. Сервис — огонь, спас мою командировку.",
            author: "Алина",
            pet: "хозяйка Рекса"
          },
          review4: {
            text: "Мой пес — старичок, ему нужен особый уход и прием лекарств. Ситтер справилась на 100%, очень внимательная и добрая девушка.",
            author: "Ольга",
            pet: "хозяйка лабрадора Графа"
          },
          review5: {
            text: "Оставляли кошку на 2 недели. Квартира в идеальном порядке, цветы политы, кошка довольна. Очень удобно, что ситтер жил у нас.",
            author: "Сергей",
            pet: "хозяин Муси"
          },
          review6: {
            text: "У меня очень активный джек-рассел, не каждый справится. Кирилл гулял с ним по 2 часа в лесу! Собака приходила домой и спала без задних лап.",
            author: "Мария",
            pet: "мама Джека"
          },
          review7: {
            text: "Первый раз пользовалась таким сервисом. Очень переживала, но видеосвязь каждый вечер меня успокоила. Все прошло супер!",
            author: "Татьяна",
            pet: "хозяйка шпица Лолы"
          },
          review8: {
            text: "Заказываю выгул, когда задерживаюсь на работе. Спасение для занятых людей. Всегда вовремя, всегда с фотоотчетом.",
            author: "Виктор",
            pet: "хозяин бигля Тоби"
          },
          review9: {
            text: "Ситтер не просто кормила кота, а играла с ним удочкой по полчаса! Такого внимания даже я ему не уделяю. 5 звезд однозначно.",
            author: "Ирина",
            pet: "мама кота Семёна"
          },
          review10: {
            text: "Щенок еще не приучен к туалету, но ситтер отнеслась с пониманием. Никаких проблем, все убрано, щенок счастлив.",
            author: "Наталья",
        ...
        referencePage: {
          ...
          form: {
            ...
            contactLabel: "Эл. почта или телефон",
        ...
        aviaCashbackConditionTitle_Final: "Как получить бонус (Важно!)",
        aviaCashbackCondition1_Final: "⚠️ Покупка должна полностью пройти в нашем приложении!\n\nЕсли вы перейдете в приложение Aviasales — покупка не засчитается, и бонус начислен не будет. Не уходите из этого окна.",
        aviaCashbackConditionTransparency_Final: "Мы возвращаем 100% комиссии вам. Цены такие же, как на Aviasales.",
        aviaCashbackConditionWarning_Final: "Внимание! Кэшбэк (возврат бонусами) не будет начислен, если откроется приложение Aviasales. Оставайтесь в браузере или в этом окне.",
        aviaCashback_Badge_Clear_Final: "Кешбэк (возврат бонусами) 1-3%",
        loadingText_Final: "Загрузка...",
        attention_Title: "Важно!",
        continue_browser: "Понятно, открыть",
        futurePartnersText_Final: "Скоро: больше партнеров с бонусами",
        partnerSectionTitle_Final: "Партнеры и Бонусы",
        ...
        subscription: {
          ...
          "featurePremiumBadgeTitleV3_marketing": "Значок \"ПРО\"",
          ...
          "featurePremiumBadgeDescV2": "Бейдж ПРО",
          "featurePremiumBadgeTitle": "ПРО",
        ...
        ourServices: {
          boarding: { title: "Передержка в доме ситтера", desc: "Ваш питомец живет в доме у ситтера. Домашняя обстановка, круглосуточный присмотр и забота." },
          houseSitting: { title: "Присмотр в вашем доме", desc: "Ситтер приезжает и живет в вашем доме. Идеально, если питомец боится новых мест." },
          dropIn: { title: "Визиты на час", desc: "Ситтер приходит к вам домой (обычно на 15-30 минут), чтобы покормить, убрать лоток и поиграть." },
          dayNanny: { title: "Дневная няня (у ситтера)", desc: `Дневной "детский сад". Вы привозите питомца утром к ситтеру и забираете вечером.` },
          walking: { title: "Выгул собаки", desc: "Активная прогулка на улице. Маршрут отслеживается по GPS, вы получите отчет с фото." }
        },
        ourGuarantees: {
          verifiedSitters: {
            title: "Проверка и обучение",
            desc: "Мы проверяем паспортные данные и открытые данные каждого кандидата. Доступ к заказам получают только те, кто успешно сдал тест на знание услуг и правил сервиса."
          },
          contract: {
            title: "Официальный договор",
            desc: "При оформлении заказа автоматически формируется электронный договор напрямую между вами и ситтером. Вы юридически защищены."
          },
          meetAndGreet: {
            title: "Бесплатное знакомство",
            desc: "Встретьтесь с ситтером до оплаты заказа. Познакомьте его с питомцем, обсудите детали и убедитесь, что вам комфортно друг с другом."
          },
          support: {
            title: "Служба Заботы 24/7",
            desc: "Мы контролируем каждый заказ. Если возникнет вопрос или нестандартная ситуация — менеджеры поддержки на связи круглосуточно, даже ночью."
          },
          vetHelp: {
            title: "Ветеринарный контроль",
            desc: "В каждый заказ включена ветеринарная помощь. Если питомцу нездоровится, мы мгновенно организуем онлайн-консультацию с ветеринаром."
          }
        },
        howItWorksSimple: {
