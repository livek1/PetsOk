    ...
    "content": [
      ...
      },
      {
        ...
        "items": [
          ...
          "<strong>Данные для верификации (KYC):</strong> Для исполнителей (ситтеров) могут запрашиваться паспортные данные. Они обрабатываются партнером по верификации и не хранятся в открытом виде.",
